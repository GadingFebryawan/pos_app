...
<div class="container">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-center">
            ...
            <img width="400" src="https://smartlink.pakar-digital.com/storage/214/photos" alt="Logo">
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <p class="text-center mt-5 lead">
                Powered By
                <a href="https://pakar-digital.com" class="font-weight-bold text-primary">Pakar Digital</a>
            </p>
        </div>
    </div>
</div>
