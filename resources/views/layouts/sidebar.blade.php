<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show {{ request()->routeIs('app.pos.*') ? 'c-sidebar-minimized' : '' }}" id="sidebar">
    <div class="c-sidebar-brand d-md-down-none">
        <a href="{{ route('home') }}">
            ...
            <img class="c-sidebar-brand-full" src="https://smartlink.pakar-digital.com/storage/214/photos" alt="Site Logo" width="150">
            <img class="c-sidebar-brand-minimized" src="https://smartlink.pakar-digital.com/storage/214/photos" alt="Site Logo" width="40">
        </a>
    </div>
