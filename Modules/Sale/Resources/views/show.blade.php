            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex flex-wrap align-items-center">
                        <div>
                            Reference: <strong>{{ $sale->reference }}</strong> | Payment Code: <strong>{{$sale->payment_code ?? "-"}}</strong>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                ...
                                <div>Exp Date: {{ !empty($sale->exp_date) ? \Carbon\Carbon::parse($sale->exp_date)->format('d M, Y') : "-" }}</div>
                                <div>
                                    Status: <strong>{{ $sale->status }}</strong>
                                </div>
                                <div>Paid Date: {{ !empty($sale->paid_date) ? \Carbon\Carbon::parse($sale->paid_date)->format('d M, Y') : "-" }}</div>
                                <div>
